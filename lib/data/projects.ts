...
export type ProjectCategory = 'All Projects' | 'Residential Projects' | 'Commercial Projects' | 'Renovation Projects' | 'Ongoing Projects';
...
export const statistics = [
  ...
  { value: 150, label: 'Skilled Professionals', icon: LayoutDashboard, suffix: '+' },
];
